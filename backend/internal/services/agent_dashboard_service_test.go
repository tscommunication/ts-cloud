...
func TestAgentDashboardAggregatesRemainScoped(t *testing.T) {
	...
	if err := db.AutoMigrate(&models.Agent{}, &models.Customer{}, &models.Package{}, &models.Subscription{}, &models.Invoice{}, &models.AgentCollection{}, &models.AgentSettlement{}); err != nil {
		t.Fatal(err)
	}
	...
	if summary.TotalCustomers != 1 || summary.ActiveSubscriptions != 1 || summary.TotalInvoiced != 1000 || summary.TotalOutstanding != 400 || summary.OverdueInvoices != 1 || summary.TotalCollected != 600 || summary.CommissionPayable != 60 {

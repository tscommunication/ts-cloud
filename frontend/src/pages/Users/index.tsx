...
function Users() {
  ...
  return <Box>
    <Box sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, justifyContent: 'space-between', gap: 2, mb: 3 }}>
      <Box><Typography variant="h4" sx={{ fontWeight: 700 }}>Users ({users.length})</Typography><Typography color="text.secondary">Manage administrator and staff accounts.</Typography></Box>

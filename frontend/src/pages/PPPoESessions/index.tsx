  ...
  return <Box>
    ...
    <Card><CardContent>
      ...
      <TableContainer><Table sx={{ minWidth: 1280 }} size="small"><TableHead><TableRow><TableCell>Username</TableCell><TableCell>Router</TableCell><TableCell>Customer</TableCell><TableCell>Package</TableCell><TableCell>Mapping</TableCell><TableCell>IP Address</TableCell><TableCell>Caller ID / MAC</TableCell><TableCell>Service</TableCell><TableCell>Uptime</TableCell><TableCell>Last Seen</TableCell><TableCell align="right">Action</TableCell></TableRow></TableHead><TableBody>
        ...
        {!sessions.isLoading && rows.length === 0 && <TableRow><TableCell colSpan={11} align="center">No matching active PPPoE users.</TableCell></TableRow>}
        {sessions.isLoading && <TableRow><TableCell colSpan={11} align="center">Loading live PPPoE users...</TableCell></TableRow>}

...
export async function getCustomerPortalMe(): Promise<CustomerPortalMe> {
  const response =
    await apiClient.get<CustomerPortalMe>('/customer-portal/me')

  return response.data
}

export async function getCustomerPortalSubscriptions():
Promise<CustomerPortalSubscription[]> {
  const response =
    await apiClient.get<CustomerPortalSubscription[]>(
...
Promise<CustomerPortalInvoice[]> {
  const response =
    await apiClient.get<CustomerPortalInvoice[]>(
...
export async function getCustomerPortalPayments():
Promise<CustomerPortalPayment[]> {
  const response =
    await apiClient.get<CustomerPortalPayment[]>(

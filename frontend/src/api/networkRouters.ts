...
export interface NetworkRouterAlert { id: number; router_id: number; router_code: string; router_name: string; type: 'HIGH_CPU' | 'HIGH_MEMORY'; severity: string; status: string; message: string; current_value: number; threshold: number; opened_at: string; last_observed_at: string; resolved_at?: string }
